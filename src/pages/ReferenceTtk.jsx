...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .page{width:210mm;height:297mm;margin:0 auto;background:#faf8f5;padding:11mm;display:flex;flex-direction:column;position:relative;overflow:hidden}
  ...
  .content{position:relative;z-index:1;display:flex;flex-direction:column;gap:5mm;height:100%}
  ...
  h1{margin:0;text-align:center;font-size:27px;line-height:1.05;color:#16332b;letter-spacing:-.03em;font-weight:900}
  .photo-wrap{width:100%;height:88mm;overflow:hidden;border-radius:18px;box-shadow:0 10px 28px rgba(31,41,55,.12);background:#eee7dc;flex:0 0 auto}
  .dish-photo{width:100%;height:100%;object-fit:cover;display:block}
  .photo-placeholder{height:100%;display:flex;align-items:center;justify-content:center;color:#8b8174;font-size:15.5px;background:#eee7dc}
  ...
  .meta-value{font-size:12px;line-height:1.2;color:#1f2937;font-weight:900;word-break:break-word}
  ...
  .block{background:#fff;border:1px solid #ece8df;border-radius:14px;padding:10px 9px;box-shadow:0 5px 14px rgba(31,41,55,.035);min-width:0;break-inside:avoid}
  h2{margin:0 0 5px;font-size:12px;line-height:1.15;color:#16332b;letter-spacing:-.01em}
  .text{font-size:12px;line-height:1.38;color:#374151;white-space:pre-wrap}
